		...
		<div align=center style="margin-top: 70px">
			<form action="register" method="post" align = left>
				<table>
					...
					<tr>
						<td>
							<input type="button" onClick="location.href='users'" value="to users list" />
						</td>
					</tr>
				</table>
				...
				<table align = center>
					...
					<tr>
						<td>Driver</td>
						<td>
							<input type="radio" name="isDispatcher" value="driver"
								onClick="changeHide('show')" />
						</td>
					</tr>
					<tr>
						<td>Dispatcher</td>
						<td>
							<input type="radio" name="isDispatcher" value="dispatcher"
								checked onClick="changeHide('hide')" />
						</td>
					</tr>
						...
						<td colspan="2">
							<table>
								...
								<tr>
									<td>bus max speed</td>
									<td>
										<input type="text" name="maxspeed" size=20 />
									</td>
								</tr>
								<tr>
									<td>does it work?</td>
									<td>
										<input type="checkbox" name="busworking" value="true" />
									</td>
								</tr>
							</table>
						</td>
