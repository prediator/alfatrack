 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.emotion.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * {@inheritDoc}
     */
    public User saveUser(User user) throws ModelExistsException {
        ...
        try {
            ...
            throw new ModelExistsException("User '" + user.getUsername() + "' already exists!");
